...
class Heroi(Personagem):
    # Classe destinada apenas controle do herói
...
class Inimigo(Personagem):
    # Classe destinada apenas controle do inimigo
...
class Jogo:
    """ Classe responsável pela gestão do jogo """
    def __init__(self):
        self.heroi = Heroi(nome="Batman", vida=100, nivel=5, habilidade="Dinheiro")
        self.inimigo = Inimigo(nome="Coringa", vida=80, nivel=5, tipo="Risada")
